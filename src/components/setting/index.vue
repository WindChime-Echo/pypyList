    ...
    <el-dropdown>
      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item @click="exportCollection">导出收藏</el-dropdown-item>
          <el-dropdown-item @click="importCollection">导入收藏</el-dropdown-item>
        </el-dropdown-menu>
      </template>
    </el-dropdown>
...
function onFileChange(e) {
  ...
  function validateObj(obj) {
    const requiredKeys = ["id", "group", "volume", "name", "flip", "start", "end", "skipRandom", "originalUrl"];
